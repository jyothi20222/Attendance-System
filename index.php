	...
	<body>
		...
		<div class = "container-fluid admin1">
			...
			<div class="attendance_log_field">
				...
				<div id="company-logo-field" class="mb-1">
					<img src="company_logo.png" alt="" width="200" height="200">
				</div>
				<div class="text-center">
				<h4>Welcome to PhiScape.</h4>
				</div>
								...
								<div class="text-center mb-4" id="log_display"></div>
									<form action="" id="att-log-frm" >
										<div class="form-group">
											...
											<input type="text" id="eno" placeholder="Enter the 8 digits with hyphens" name="eno" class="form-control col-sm-12">
										</div>
										<center>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-6' data-id="1">IN First Shift</button>
											<button type="button" class='btn btn-sm btn-secondary log_now col-sm-6' data-id="2">OUT First Shift</button>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-6' data-id="3">IN Second Shift</button>
											<button type="button" class='btn btn-sm btn-secondary log_now col-sm-6' data-id="4">OUT Second Shift</button>
										</center>
